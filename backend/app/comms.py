...
def post_channel_repo_ready_with_graph_token(
    ...
    with httpx.Client(
        ...
        content = (
            ...
            f"<p>If you need any help — repo access, environment setup, or anything "
            f"else — please drop a message in the "
            f"<a href=\"https://teams.microsoft.com/l/channel/"
            f"19%3Ab4966efc4c4540bab896d28e09db2cb6%40thread.tacv2/"
            f"2026%20-%20Help%20Line?groupId=8de12ada-4c6a-4e6a-aa1c-79dbc0d7f606&amp;"
            f"tenantId=2c94bed6-d675-4d3d-a53b-7b461fd6acc2\" "
            f"style=\"color:#0a4f99;font-weight:600;\">"
            f"2026 - Help Line</a> channel.</p>"
