...
TEMPLATES: list[EmailTemplate] = [
    EmailTemplate(
        ...
        body=(
            ...
            "Members:\n{member_list}\n\n"
            "Idea on file:\n  {idea_short}\n\n"
            "Prize: Top teams win Bose QuietComfort Ultra Headphones.\n\n"
            "What happens next:\n"
        ...
        body_html=_html_wrap(
            ...
            "  <div style='color:#1a1f26;font-size:15px;line-height:1.5;'>Top teams take home <strong>Bose QuietComfort Ultra Headphones</strong>.</div>\n"
            "</td></tr>\n"
            "</table>\n"
