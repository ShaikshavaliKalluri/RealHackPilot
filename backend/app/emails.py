...
TEMPLATES: list[EmailTemplate] = [
    EmailTemplate(
        ...
        body=(
            ...
            "  4. On event days, connect with builders, mentors, and judges from across RealPage.\n\n"
            "Resources:\n"
            "  - Hackathon guidelines: https://realpage-my.sharepoint.com/:w:/p/bhaskar_jaddu/IQAwPZcx2AwKT46n8kw3kNMVAaZu8ckuxNfQWZGu4_vWWbc?e=im6Bkv\n"
            "  - Central RealHack 2026 Teams channel (organizing-team announcements):\n"
            "    https://teams.microsoft.com/l/channel/19%3AT8z6462WZdvi2sCucjnw1HDoZgdS7-1W9ztbdqVwTPY1%40thread.tacv2/General?groupId=8de12ada-4c6a-4e6a-aa1c-79dbc0d7f606&tenantId=2c94bed6-d675-4d3d-a53b-7b461fd6acc2\n\n"
        ...
        body_html=_html_wrap(
            ...
            "  <li>On event days, <strong>connect with builders, mentors, and judges</strong> from across RealPage.</li>\n"
            "</ul>\n"
            "<h2>Resources</h2>\n"
            "<table role='presentation' cellpadding='0' cellspacing='0' border='0' width='100%' style='margin:6px 0 18px;background:#f4f8fd;border-radius:8px;border-left:4px solid #0078d4;'>\n"
            "<tr><td class='info-pad' style='padding:16px 22px;'>\n"
            "  <div style='margin-bottom:10px;'>\n"
            "    <a href='https://realpage-my.sharepoint.com/:w:/p/bhaskar_jaddu/IQAwPZcx2AwKT46n8kw3kNMVAaZu8ckuxNfQWZGu4_vWWbc?e=im6Bkv' style='color:#0078d4;font-weight:700;text-decoration:none;'>&#128218; Hackathon Guidelines</a>\n"
            "    <div style='color:#5b6b7c;font-size:13px;margin-top:2px;'>Rules, judging axes, and event-day flow.</div>\n"
            "  </div>\n"
            "  <div>\n"
            "    <a href='https://teams.microsoft.com/l/channel/19%3AT8z6462WZdvi2sCucjnw1HDoZgdS7-1W9ztbdqVwTPY1%40thread.tacv2/General?groupId=8de12ada-4c6a-4e6a-aa1c-79dbc0d7f606&tenantId=2c94bed6-d675-4d3d-a53b-7b461fd6acc2' style='color:#0078d4;font-weight:700;text-decoration:none;'>&#128172; Central RealHack 2026 Teams channel</a>\n"
            "    <div style='color:#5b6b7c;font-size:13px;margin-top:2px;'>Organizing-team announcements (separate from your private team channel coming soon).</div>\n"
            "  </div>\n"
            "</td></tr>\n"
            "</table>\n"
    ...
    EmailTemplate(
        ...
        body_html=_html_wrap(
            "<p style='text-align:justify;'>Dear Team,</p>\n"
            "<p style='text-align:justify;'>We're thrilled to announce the kickoff of "
            "<strong>RealHack 2026</strong> &mdash; our annual hackathon that brings together "
            "creativity, collaboration, and cutting-edge ideas!</p>\n"
            "<table role='presentation' cellpadding='0' cellspacing='0' border='0' width='100%' style='margin:18px 0;background:#f4f8fd;border-radius:8px;border-left:4px solid #0078d4;'>\n"
            "<tr><td class='info-pad' style='padding:18px 22px;'>\n"
            "<table role='presentation' cellpadding='0' cellspacing='0' border='0' width='100%'>\n"
            "  <tr><td style='padding-bottom:14px;'>\n"
            ...
            "</td></tr>\n"
            "</table>\n"
            "<p style='text-align:justify;'>For our colleagues outside India, we've got you covered. "
            "You can join us virtually from wherever you are. We understand time zones vary, so we'll "
            "also be sharing a recording of the session for those who can't attend live.</p>\n"
            "<p style='text-align:justify;'>Whether you're joining in person or online, this is your "
            "chance to get inspired, connect with fellow innovators, and gear up for an exciting "
            "hackathon ahead.</p>\n"
            "<p style='text-align:justify;'>Let's kick off <strong>RealHack 2026</strong> with energy "
            "and enthusiasm. We can't wait to see you there!</p>\n"
