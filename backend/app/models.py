...
class Team(Base):
    ...
    # Per-round judge-comment summaries, keyed by string round ('r1', 'r2', ...).
    # Each value: {"summary": str, "comment_count": int, "generated_at": ISO,
    #              "generated_by_email": str | None, "edited_at": ISO | None,
    #              "posted_at": ISO | None, "posted_message_id": str | None}
    # Generated by the LLM from JudgeScore.comment rows; an organizer can edit
    # the text before posting it to the team's Teams channel.
    feedback_summary: Mapped[dict | None] = mapped_column(JSON, default=dict)
