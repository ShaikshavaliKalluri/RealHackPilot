...
export function PrintableScorecards({ round: roundProp }: Props = {}) {
  ...
  return (
    <div className="bg-white min-h-screen text-slate-900 scorecards-root">
      ...
      <div className="no-print border-b border-slate-200 px-6 py-3 sticky top-0 bg-white z-10 flex items-center justify-between gap-4">
        <div>
          <h1 className="font-bold text-slate-900">
            Paper-fallback scorecards · Round {round} · {panels.length} panel{panels.length === 1 ? '' : 's'}
          </h1>
